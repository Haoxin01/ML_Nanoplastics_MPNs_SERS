...
def main():
    ...
    # set data directory
    data_addr = 'D:/Nanoplastics-ML/sample_data_augumented'
    result_addr = 'D:/Nanoplastics-ML/result'

    # batch process all files and return X and y with shuffling
    # if cache01 exist, load from cache01; else, process data and store to cache01
    ...
    if not os.path.exists(cache_dir):
        ...
        print('loading data from cache01...')
